...
class GPUController():
	...
	def disableGPUControl(parent):
		...
		MessageDialogBox(parent.appWindow, "Disabled GPU fan control.")

	# triggered by "Enable" button
	def enableGPUControl(parent):
		...
		MessageDialogBox(parent.appWindow, "Enabled GPU fan control.")
